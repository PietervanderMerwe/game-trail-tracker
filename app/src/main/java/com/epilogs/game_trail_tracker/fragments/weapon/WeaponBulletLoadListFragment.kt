 ...
 * Use the [WeaponBulletLoadListFragment.newInstance] factory method to
...
class WeaponBulletLoadListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment WeaponBulletLoadListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WeaponBulletLoadListFragment().apply {
