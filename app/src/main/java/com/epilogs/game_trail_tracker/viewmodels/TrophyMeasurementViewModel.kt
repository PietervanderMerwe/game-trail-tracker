...
class TrophyMeasurementViewModel (application: Application) : AndroidViewModel(application) {
    ...
    fun insertTrophyMeasurement(trophyMeasurement: TrophyMeasurement) = viewModelScope.launch {
        trophyMeasurementDao.insertTrophyMeasurement(trophyMeasurement)
        insertionSuccess.postValue(true)
    }

    fun insertTrophyMeasurements(trophyMeasurements: List<TrophyMeasurement>) = viewModelScope.launch {
        trophyMeasurementDao.insertTrophyMeasurements(trophyMeasurements)
        insertionSuccess.postValue(true)
    }

    fun getAllTrophyMeasurements(): LiveData<List<TrophyMeasurement>> = liveData {
        val trophyMeasurements = trophyMeasurementDao.getAllTrophyMeasurements()
        emit(trophyMeasurements)
    }

    fun getTrophyMeasurementsByTrophyId(trophyId: Int): LiveData<List<TrophyMeasurementWithType>> = liveData {
        val trophyMeasurements = trophyMeasurementDao.getTrophyMeasurementsByTrophyId(trophyId)
        emit(trophyMeasurements)
    }
